...
object LightTheme : ColorTheme {
    ...
    override val Secondary   = Color(0xFF17375A)
    override val LightShadow = Color(0x4DFFFFFF)
    override val DarkShadow  = Color(0xCC4C4D50)
    override val Text        = Color(0xEB181818)
    override val Tint        = Color(0xCC333333)
    override val DarkSurface = Color(0x33C5C5C5)
...
object DarkTheme : ColorTheme {
    ...
    override val Secondary   = Color(0xFF527AA7)
    ...
    override val DarkSurface = Color(0xF0181818)
